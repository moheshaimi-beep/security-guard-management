-- Security Guard Management Database Schema for MySQL/XAMPP
...
CREATE TABLE IF NOT EXISTS users (
    ...
    last_login DATETIME,
    notification_preferences JSON DEFAULT ('{"email": true, "sms": true, "whatsapp": true, "push": true}'),
    refresh_token TEXT,
...
CREATE TABLE IF NOT EXISTS assignments (
    ...
    INDEX idx_status (status),
    UNIQUE KEY unique_assignment (agent_id, event_id, deleted_at),
...
INSERT INTO users (id, employee_id, first_name, last_name, email, password, phone, role, status)
VALUES (
    UUID(),
    'ADMIN001',
    'Admin',
