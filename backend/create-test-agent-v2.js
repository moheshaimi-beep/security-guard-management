...
async function createTestAgent() {
  try {
    ...
    // Convertir en string JSON car le champ facialVector est de type TEXT
    ...
    console.log('Vecteur facial créé avec', testFacialVector.length, 'valeurs');
    console.log('JSON string length:', facialVectorJSON.length);
    ...
    const testAgent = await User.create({
      ...
      role: 'agent',
      status: 'active',
      facialVector: facialVectorJSON, // String JSON, pas de array
