...
async function createTestAgent() {
  try {
    ...
    // Créer l'agent sans le vecteur facial d'abord
    ...
    }, { hooks: false }); // SANS hook pour éviter chiffrement immédiat

    console.log('Agent créé sans vecteur facial');

    // Maintenant mettre à jour avec le vecteur facial (hooks activés)
    console.log('Mise à jour du vecteur facial...');
